...
assert.ok(fs.existsSync(jsURL), "dist/3.3.8-alpha/mujoco.js missing");
assert.ok(fs.existsSync(wasmURL), "dist/3.3.8-alpha/mujoco.wasm missing");
...
console.log("mesh smoke(3.3.8-alpha) OK");
